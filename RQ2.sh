...
cd /home/Blinpy-app/evaluation_results/bug_with_truth/
...
do {
    ...
    do
        ...
        git reset --hard $ver
        cd /home/Blinpy-app/evaluation_results/bug_with_truth/$folder
        bug=$(echo $line|cut -d "L" -f 1)
        python "/home/Blinpy-app/local.py" "/home/Blinpy-app" "/home/Blinpy-app/evaluation_results/bug_with_truth/$folder/$bug""L" "/home/Blinpy-app/evaluation_results/Bugzbook_codebases/$folder"
    done < /home/Blinpy-app/evaluation_results/bug_with_truth/$folder"/""id_time.txt"
